    ...
    function t(e) {
        ...
        "light-mode-switch" === e
            ? (n("html").removeAttr("dir"),
              ...
              n("#app-style").attr("href", "assets/auth/css/app.min.css"),
            ...
            ? (n("html").removeAttr("dir"),
              ...
              n("#bootstrap-style").attr(
                  "href",
                  "assets/auth/css/bootstrap-dark.min.css"
              ),
              n("#app-style").attr("href", "assets/auth/css/app-dark.min.css"),
            ...
            : 1 == n("#rtl-mode-switch").prop("checked") &&
              ...
              n("#app-style").attr("href", "assets/auth/css/app-rtl.min.css"),
              n("html").attr("dir", "rtl"),
